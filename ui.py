...
title = tk.Label(text="Click below to choose picture for testing disease....", background = "white", fg="Black", font=("", 15))
title.grid()
def bact():
    window.destroy()
    window1 = tk.Tk()
...
def analysis():
    ...
    for num, data in enumerate(verify_data):
        ...
        if str_label == 'bacterial':
            ...
            r = tk.Label(text='Click below for remedies...', background="white", fg="Black", font=("", 15))
            ...
            r = tk.Label(text='Plant is healthy', background="white", fg="Black",
                         font=("", 15))
...
def openphoto():
    ...
    fileName = askopenfilename(initialdir='C:/Users/pritu/Desktop', title='Select image for analysis ',
                           filetypes=[('image files', '.jpg')])
    dst = 'C:/SimpleTechFinale/SimpleTech/Plant Disease Prediction/testpicture'
